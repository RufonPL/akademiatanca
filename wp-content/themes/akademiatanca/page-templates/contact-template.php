    ...
    <div class="row contact-page">
    	...
    	<div class="col-md-4 col-sm-6 col-xs-12">
        	<div class="row cp-details">
            	<?php if($cp_details_header) : ?><span style="font-size:18px;" class="contact-header"><strong><?php echo esc_html($cp_details_header); ?></strong></span><?php endif; ?><br/><br/><br/>
                <?php if($phone) : ?>
                <div class="cp-icon">
                ...
                <div class="cp-icon">
                    ...
                    <div class="cpi-text">
                    	<span><strong>Telefon kom.</strong></span><br/>
                ...
                <div class="cp-icon">
                    ...
                    <div class="cpi-text">
                        ...
                        <span><?php echo antispambot(esc_html($email)); ?></span>
                    </div><!--end cpi text-->
                </div><!--end cp phone-->	
                <?php endif; ?>
            </div><!--end cp details-->
            ...
            <div class="row cp-info">
            	<?php if($cp_info_header) : ?><span style="font-size:18px;" class="contact-header"><strong><?php echo esc_html($cp_info_header); ?></strong></span><?php endif; ?><br/><br/><br/>
                ...
                <div class="cp-info-phones row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 cpi-icon">
                        ...
                        <div class="cpi-text">
                            <span><strong>Telefon</strong></span><br/>
                            <span><?php echo esc_html($phone['_pn_phone']); ?></span>
                        </div><!--end cpi text-->
                    </div><!--end col-->
                    <?php endforeach; ?>
            ...
            <div class="row cp-hours">
            	<?php if($cp_hours_header) : ?><span style="font-size:18px;" class="contact-header"><strong><?php echo esc_html($cp_hours_header); ?></strong></span><?php endif; ?><br/><br/><br/>
                <?php if($cp_hours) : ?>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
        	<div class="row cp-addresses">
            	<?php if($cp_addresses_header) : ?><span style="font-size:18px;" class="contact-header"><strong><?php echo esc_html($cp_addresses_header); ?></strong></span><?php endif; ?><br/><br/><br/>
                <?php if($cp_addresses) : ?>
                <div class="row cpa-items">
					...
					?>
                    <div class="cpa-item">
                    	<?php if($add_name) : ?><span style="font-size:18px;" class="bold"><?php echo esc_html($add_name); ?></span><?php endif; ?><br/><br/>
                        <?php if($add_address) : ?><span><?php echo strip_tags(p2br($add_address), '<br>'); ?></span><?php endif; ?><br/><br/>
                        <?php if($add_hours) : ?><span><?php echo strip_tags(p2br($add_hours), '<br><strong>'); ?></span><?php endif; ?><br/>
                        <?php if($add_phone) : ?><span><?php echo strip_tags($add_phone, '<br>'); ?></span><?php endif; ?>
                    </div><!--end cpa item-->
                    <?php endforeach; ?>
                </div><!--end cpa items-->
                <?php endif; ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
        	<div class="row cp-form">
            	<?php if($cp_form_header) : ?><span style="font-size:18px;" class="contact-header"><strong><?php echo esc_html($cp_form_header); ?></strong></span><?php endif; ?>
                <?php if($cp_form) : ?>
