                                ...
                                <div class="signup-table signup-container">
                                    ...
                                    <?php foreach($signup_table as $row) : ?>
                                        ...
                                        <div class="table-responsive">
											...
											$hours = $course['_dc_start_time'].'-'.$course['_dc_end_time'];
											$dates = date('d.m', strtotime($course['_dc_start_time'])).'-'.date('d.m', strtotime($course['_dc_end_time']));
											$place = $course['_dc_place'];
											$instructor = get_the_title($course['_dc_instructor']);
											...
											?>
                                                    <tr class="st-course" data-course-name="<?php echo esc_html($name); ?>" data-course-type="<?php echo esc_html($type); ?>" data-course-level="<?php echo esc_html($level); ?>">
                                                        <td class="stc-number"><?php echo esc_html($number); ?></td>
                                                        <td class="stc-day">
                                                        <?php if($days) : ?>
                                                        ...
                                                        <td class="stc-time"><?php echo esc_html($hours); ?></td>
                                                        <td class="stc-date"><?php echo $dates; ?></td>
                                                        <td class="stc-place"><?php echo esc_html($place); ?></td>
                                                        <td class="stc-instructor"><?php echo esc_html($instructor); ?></td>
                                                        <td class="stc-price"><?php echo esc_html($price); ?> zł</td>
                                            ...
                                            <?php foreach($courses as $course) : ?>
                                                    <tr class="st-course" data-course-name="<?php echo esc_html($name); ?>" data-course-type="<?php echo esc_html($type); ?>" data-course-level="<?php echo esc_html($level); ?>">
														...
														<?php if($course['_course_day']) : ?>
                                                            ...
                                                            <p class="no-margin"><?php echo esc_html($day['_cd_day']); ?></p>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                        </td>
