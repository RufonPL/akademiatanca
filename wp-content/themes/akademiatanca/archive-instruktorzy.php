...
<div class="container page-content">
	<?php section_header(get_field('_page_header', template_id('instructors')), template_id('instructors')); ?>
    <?php if(have_posts()) : ?>
    <div class="row instructors">
    	<?php while(have_posts()) : the_post(); ?>
        <?php  
		$photo   = get_field('_instructor_image');
		$info    = get_field('_instructor_info');
		$courses = get_field('_instructor_courses');
		?>
