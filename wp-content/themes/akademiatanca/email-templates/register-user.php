...
?>
	<div class="em-container">
        ...
        <div class="em-content text-center">
        	<h1>Twoje konto zostało założone</h1>
            <h2>Logując się za pomocą danych poniżej możesz sprawdzać swoje kursy tańca:</h2>
            <br/>
            <table class="table table-bordered">
                ...
                <tr>
                	<td>Twój kod QR</td>
                    <td><img src="http://www.akademiatanca.com.pl/prounit/nr.php?id=<?php echo $qr_id; ?>"></td>
                </tr>
            </table>
        </div><!--end em content-->
